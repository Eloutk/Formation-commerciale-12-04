      ...
      <div className="mx-auto max-w-6xl space-y-6">
        <div>
          ...
          <p className="max-w-2xl text-muted-foreground">
            Gérez les contenus ludiques de la Home : question du jour, Devine la plateforme, journées
            mondiales et anniversaires.
          </p>
        </div>

        <Tabs defaultValue="daily" className="space-y-4">
          <TabsList className="grid h-auto w-full grid-cols-2 gap-1 bg-[#EEEEEE] p-1 md:grid-cols-4">
