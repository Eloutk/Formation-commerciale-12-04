...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/media', destination: '/guides/link-library', permanent: true },
      { source: '/guides/media', destination: '/guides/link-library', permanent: true },
      ...
      { source: '/mon-espace', destination: '/mon-espace/mes-projets', permanent: false },
      {
        ...
        destination: '/mon-espace/atterissage',
        permanent: true,
      },
      {
      ...
      {
        source: '/mon-espace/meilleur-atterissage',
        destination: '/mon-espace/atterissage',
        permanent: true,
      },
      {
